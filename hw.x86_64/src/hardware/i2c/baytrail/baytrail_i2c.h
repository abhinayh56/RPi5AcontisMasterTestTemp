...
#ifndef __BAYTRAIL_I2C_H_INCLUDED
#define __BAYTRAIL_I2C_H_INCLUDED
...
#define DW_IC_TAR_10BITADDR_MASTER          (0x01u << 12)
...
#define ARBT_LOST                           12
#define ARBT_USER_ARBT                      16

#define DW_IC_TX_ABRT_7B_ADDR_NOACK         (1U << ABRT_7B_ADDR_NOACK)
#define DW_IC_TX_ABRT_10ADDR1_NOACK         (1U << ABRT_10ADDR1_NOACK)
#define DW_IC_TX_ABRT_10ADDR2_NOACK         (1U << ABRT_10ADDR2_NOACK)
#define DW_IC_TX_ABRT_TXDATA_NOACK          (1U << ABRT_TXDATA_NOACK)
#define DW_IC_TX_ABRT_GCALL_NOACK           (1U << ABRT_GCALL_NOACK)
#define DW_IC_TX_ABRT_GCALL_READ            (1U << ABRT_GCALL_READ)
#define DW_IC_TX_ABRT_SBYTE_ACKDET          (1U << ABRT_SBYTE_ACKDET)
#define DW_IC_TX_ABRT_SBYTE_NORSTRT         (1U << ABRT_SBYTE_NORSTRT)
#define DW_IC_TX_ABRT_10B_RD_NORSTRT        (1U << ABRT_10B_RD_NORSTRT)
#define DW_IC_TX_ABRT_MASTER_DIS            (1U << ABRT_MASTER_DIS)
#define DW_IC_TX_ARBT_LOST                  (1U << ARBT_LOST)
#define DW_IC_TX_ARBT_USER_ARBT             (1U << ARBT_USER_ARBT)
...
#define SDA_HOLD_TIME_VALUE_ns              350

#define DW_IC_COMP_TYPE_VALUE               0x44570140

#define DW_IC_CLOCK_PARAMS_100MHZ           100000000
#define DW_IC_CLOCK_PARAMS_133MHZ           133000000

#define BAYTRAIL_I2C_TIMEOUT                20
